...
- Adds `vocal-level` for pre-compressor vocal clip gain on selected item take volume envelopes, using macro-to-micro leveling around the `-18 dBFS = 0 VU` working point.
