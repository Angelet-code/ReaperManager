...
export function buildVocalLevelCommand(options = {}) {
  ...
  return {
    ...
    mesoGapMs: parseNumberOption(options.mesoGapMs ?? options["meso-gap-ms"] ?? 350, "Meso gap ms", 50, 5000),
    mesoMinZoneMs: parseNumberOption(options.mesoMinZoneMs ?? options["meso-min-zone-ms"] ?? 450, "Meso minimum zone ms", 100, 10000),
    mesoMaxZonesPerMacro: parseNumberOption(options.mesoMaxZonesPerMacro ?? options["meso-max-zones-per-macro"] ?? 24, "Meso max zones per macro", 1, 64),
    ...
    microClearDropDb: parseNumberOption(options.microClearDropDb ?? options["micro-clear-drop-db"] ?? 4, "Micro clear drop dB", 0, 24),
    microBoostStrength: parseNumberOption(options.microBoostStrength ?? options["micro-boost-strength"] ?? 0.45, "Micro boost strength", 0, 1),
    microCutStrength: parseNumberOption(options.microCutStrength ?? options["micro-cut-strength"] ?? 0.55, "Micro cut strength", 0, 1),
